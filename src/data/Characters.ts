...
export const Characters: CharactersDatabase = {
  ...
  boyStudent: new Character({
    ...
    locations: ['City', 'Hospital', 'School', 'Shrine'],
    startingLocation: 'School',
  }),
  ...
  shrineMaiden: new Character({
    ...
    name: 'Shrine Maiden',
    descriptors: ['Student', 'Girl'],
    locations: ['Hospital', 'School', 'Shrine'],
    startingLocation: 'Shrine',
  }),
  ...
  officeWorker: new Character({
    ...
    name: 'Office Worker',
    descriptors: ['Adult', 'Man'],
    locations: ['City', 'Hospital', 'Shrine'],
    startingLocation: 'City',
  }),
  ...
  henchman: new Character({
    ...
    descriptors: ['Adult', 'Man'],
    locations: ['City', 'Hospital', 'School', 'Shrine'],
    startingLocation: 'Choose Every Loop',
  }),
  // Midnight Circle
